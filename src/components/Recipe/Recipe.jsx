        ...
        <div className="card bg-base-100 border border-[#28282833] p-4 space-y-3">
            ...
            <div className="card-body p-0 space-y-3">
                ...
                <div className='border-y border-[#2828281A] py-5'>
                    ...
                    <ul>
                    {
                        ingredients.map((ingredient, idx) => <li className='text-[#878787] list-disc ml-5' key={idx}>{ingredient}</li>)
                    }
                    </ul>
                </div>
                ...
                <div className="card-actions">
                    <button onClick={() => handleWantToCook(recipe)} className="btn bg-red-500 hover:bg-red-600 px-5 text-white text-[16px] md:text-lg rounded-full duration-500">Want to Cook</button>
                </div>
