...
const Banner = () => {
    return (
        <div className="container mx-auto max-w-[1180px] px-5">
            <div className="hero py-12 md:py-20 lg:py-28 bg-no-repeat bg-cover bg-center bg-[linear-gradient(45deg,rgba(17,17,17,0.50),rgba(17,17,17,0.50)),url(./images/chef-cooking.jpg)] rounded-2xl" >
                <div className="hero-content text-center text-neutral-content">
                    <div className="w-full md:w-4/5 lg:w-2/3 space-y-8">
                        ...
                        <button className="btn bg-transparent hover:bg-red-600 px-5 text-white text-sm md:text-lg rounded-full">Our Feedback</button>
